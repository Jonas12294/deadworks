...
struct ManagedCallbacks {
    ...
    using OnAddModifierFn = bool(CORECLR_DELEGATE_CALLTYPE *)(void *modifierProp, void *caster, const char *modifierName, int32_t debuffType, int32_t team, uint32_t hAbility);
